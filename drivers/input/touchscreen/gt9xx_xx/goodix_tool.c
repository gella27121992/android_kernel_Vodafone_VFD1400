...
#define RAWDATA_TEST_PROC_NAME "gmnode_tp_rawdata"
#pragma pack(1)
typedef struct{
...
/* [PLATFORM]-Removed-BEGIN by TCTSZ.lizhi.wu, 2015.1.30*/
/*
...
*/
/* [PLATFORM]-Removed-End by TCTSZ.lizhi.wu, 2015.1.30*/
...
s32 init_wr_node(struct i2c_client *client)
{
    ...
    //tool_set_proc_name(procname);		/* [PLATFORM]-Removed by TCTSZ.lizhi.wu, 2015.1.30*/
    //goodix_proc_entry = create_proc_entry(procname, 0666, NULL);
    //goodix_proc_entry = proc_create(procname, 0666, NULL, &tool_ops);
    goodix_proc_entry = proc_create(RAWDATA_TEST_PROC_NAME, 0664, NULL, &tool_ops);
