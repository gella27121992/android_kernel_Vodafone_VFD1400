				...
				unsigned long *freq, u32 devfreq_flags)
{
	...
	mmc_host_clk_hold(host);
	//mmc_get_card(host->card);//CR990028 device freeze, qualcomm case ID 02422794, liang.tang@tcl.com removed
	...
	//mmc_put_card(host->card);//CR990028 device freeze, qualcomm case ID 02422794, liang.tang@tcl.com removed
