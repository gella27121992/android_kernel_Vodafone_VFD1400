...
int mdss_dsi_panel_reset(struct mdss_panel_data *pdata, int enable)
{
	...
	if (enable) {
		...
		//[BUGFIX]-Mod-BEGIN by SCDTABLET.jinghuang@tcl.com,04/14/2016,1936397
	...
	int ndx)
{
	...
	if(strncmp(panel_name, "nt51021b video mode dsi panel dpt", strlen("nt51021b video mode dsi panel dpt")) == 0) {
	   tct_panel_id = 1;
	} else if(strncmp(panel_name, "nt51021b video mode dsi panel tdt", strlen("nt51021b video mode dsi panel tdt")) == 0){
	   tct_panel_id = 2;
	}
