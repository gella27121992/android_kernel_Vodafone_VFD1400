...
//[BUGFIX]-Mod-BEGIN by SCDTABLET.jinghuang@tcl.com,02/04/2016,1564333,
//speaker function and switch function.
#ifdef CONFIG_TCT_8937_POP4104GVDF
int power_speaker_pa=-1;
extern int speaker_hp_sync_flag;
int audio_switch_gpio;			///* [PLATFORM]-Add by TCTSZ.lizhi.wu, 2016.03.17*/
...
/* [PLATFORM]-Add-BEGIN by TCTSZ.lizhi.wu, 2016.03.17*/
#ifdef CONFIG_TCT_8937_POP4104GVDF
int msm8x16_wcd_audio_switch_to_speaker(void)
{
	int err;
...
#endif
/* [PLATFORM]-Add-END by TCTSZ.lizhi.wu, 2016.03.17*/
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		...
		if (strnstr(w->name, internal1_text, strlen(w->name))) {
			//[BUGFIX]-Mod-BEGIN by SCDTABLET.jinghuang@tcl.com,02/26/2015,1696678
			//set MIC_N internal pull down.
			 #ifdef CONFIG_TCT_8937_POP4104GVDF
